    ...
    <div className="min-h-screen bg-[#f5f6f7] relative">
      ...
      <div className="flex items-center justify-between px-6 pt-6 mb-8">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold text-[#212529]">Terms & Privacy</h1>
        </div>
      </div>
      ...
      <div className="px-6 pb-32">
        <div className="bg-white p-6 rounded-3xl shadow-sm mb-6">
          <h2 className="text-xl font-semibold text-[#212529] mb-4">Terms of Service</h2>
          <p className="text-gray-500 mb-4">
            These terms govern your use of Senso. By using Senso, you agree to these terms.
          </p>
          <h2 className="text-xl font-semibold text-[#212529] mb-4">Privacy Policy</h2>
          <p className="text-gray-500">
            Your privacy is important to us. Our Privacy Policy explains how we collect, use, and share information.
          </p>
        </div>
      </div>
