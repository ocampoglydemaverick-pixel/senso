...
const MobileOnlyScreen: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#212529] via-gray-800 to-black text-white p-8 text-center">
      ...
      <h1 className="text-3xl font-bold mb-6">iOS Only</h1>
      
      <p className="text-white/70 mb-8">
        Senso is designed exclusively for iOS devices. Please visit this site on your iPhone or iPad.
      </p>
      
      <div className="flex flex-col items-center gap-4">
        <div className="p-4 rounded-lg bg-white/10 max-w-xs">
          <i className="fa-brands fa-apple text-3xl mb-3"></i>
          <p className="text-sm text-white/90">
            For the best experience, please open this website on an iOS device.
          </p>
        </div>
      </div>
    </div>
